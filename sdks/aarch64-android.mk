...
TARGET_CPP=$(TOOLCHAIN_BIN_DIR)/$(TARGET_NAME)-cpp
TARGET_CXXCPP=$(TOOLCHAIN_BIN_DIR)/$(TARGET_NAME)-cpp
...
.stamp-toolchain-$(TARGET_DIR):
	$(NDK_PLATFORM_ROOT)/build/tools/make-standalone-toolchain.sh  --platform=$(ANDROID_PLATFORM) --arch=arm64 --install-dir=toolchains/$(TARGET_DIR) --toolchain=aarch64-linux-android-clang && \
