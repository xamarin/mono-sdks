TARGET_ANDROID_PLATFORM=android-4
...
TARGET_NDK_TOOLCHAIN_NAME=arm-linux-androideabi-clang
TARGET_NDK_TOOLCHAIN_ARCH=arm
...
TARGET_LDFLAGS=$(COMMON_LDFLAGS) -Wl,--fix-cortex-a8 \
			-Wl,-rpath-link=$(TARGET_NDK_PLATFORM)/arch-arm/usr/lib,-dynamic-linker=/system/bin/linker \
			-L$(TARGET_NDK_PLATFORM)/arch-arm/usr/lib

TARGET_EXTRA_CFLAGS=-mtune=cortex-a8 -march=armv7-a -mfpu=vfp -mfloat-abi=softfp
TARGET_EXTRA_CPPFLAGS=-I$(TARGET_NDK_PLATFORM)/arch-arm/usr/include/
